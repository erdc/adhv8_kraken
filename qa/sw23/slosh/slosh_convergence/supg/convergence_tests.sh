...
#sw_set="slosh2d3d.6.dt sloshfull3d.6.dt"
testcase="superfile"

adh_root_path="/workspace/gajanan/adh_2017/adh_01_31_2018"
TestcaseRepoPath="/workspace/gajanan/adh_2017/testcases/slosh_convergence/finalslosh3.PG"
...
cores_set="10"         # Edit to change number of cores in parallel runs
