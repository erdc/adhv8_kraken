...
void slin_sys_free(SLIN_SYS *lin_sys) {
    ...
    if(lin_sys->vals_diag!=NULL){
        lin_sys->cols_diag= (double *) tl_free(sizeof(double), lin_sys->nnz_diag, lin_sys->vals_diag);
    }
    ...
    if(lin_sys->vals_off_diag!=NULL){
        lin_sys->cols_off_diag= (double *) tl_free(sizeof(double), lin_sys->nnz_off_diag, lin_sys->vals_off_diag);
    }
