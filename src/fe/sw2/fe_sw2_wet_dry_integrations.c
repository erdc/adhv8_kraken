...
void inline fe_sw2_wd_integrate_triangle_f(SVECT *elem_nds, double *elem_head, SVECT2D *grad_phi, SVECT2D *v, SVECT2D *v_wet_dry, double *f, double *f_wet_dry, double djac, double *vars, DOF_3 *rhs) {
...
void inline fe_sw2_wd_continuity_temporal_triangle(SVECT *elem_nds, double *elem_head, SVECT2D *grad_phi, SVECT2D *v, SVECT2D *v_wet_dry, double *f, double *f_wet_dry, double djac, double *vars, DOF_3 *rhs) {
...
void inline fe_sw2_wd_convection_triangle(SVECT *elem_nds, double *elem_head, SVECT2D *grad_phi, SVECT2D *v, SVECT2D *v_wet_dry, double *f, double *f_wet_dry, double djac, double *vars, DOF_3 *rhs) {
...
void inline fe_sw2_wd_gls_convection_triangle(SVECT *elem_nds, double *elem_head, SVECT2D *grad_phi, SVECT2D *v, SVECT2D *v_wet_dry, double *f, double *f_wet_dry, double djac, double *vars, DOF_3 *rhs) {
    ...
    rhs[0].c_eq += djac * dt * c * (u_avg * dhdx + h_avg * dudx + v_avg * dhdy + h_avg * dvdy);
    rhs[0].x_eq += djac * dt * c * (u_avg * dudx + v_avg * dudy);
    rhs[0].y_eq += djac * dt * c * (u_avg * dvdx + v_avg * dvdy);
}
...
void inline fe_sw2_wd_pressure_triangle(SVECT *elem_nds, double *elem_head, SVECT2D *grad_phi, SVECT2D *v, SVECT2D *v_wet_dry, double *f, double *f_wet_dry, double djac, double *vars, DOF_3 *rhs) {
...
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
void inline fe_sw2_wd_boundaryPressure_triangle(SVECT *elem_nds, double *elem_head, SVECT2D *grad_phi, SVECT2D *v, SVECT2D *v_wet_dry, double *f, double *f_wet_dry, double djac, double *vars, DOF_3 *elem_rhs) {
    ...
    for (iedge=0; iedge<NDONTRI; iedge++) {
        ...
        elem_rhs[nd1].x_eq += dely * rhs[0];
        elem_rhs[nd2].x_eq += dely * rhs[1];
        elem_rhs[nd1].y_eq += delx * rhs[0];
        elem_rhs[nd2].y_eq += delx * rhs[1];
    }
...
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
void inline fe_sw2_wd_densityPressure_triangle(SVECT *elem_nds, double *elem_head, SVECT2D *grad_phi, SVECT2D *v, SVECT2D *v_wet_dry, double *f, double *f_wet_dry, double djac, double *vars, DOF_3 *rhs) {
    int i;
    double dt = vars[0];
    double c = vars[1];
...
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
void inline fe_sw2_wd_densityBodyForce_triangle(SVECT *elem_nds, double *elem_head, SVECT2D *grad_phi, SVECT2D *v, SVECT2D *v_wet_dry, double *f, double *f_wet_dry, double djac, double *vars, DOF_3 *rhs) {
    int i;
    double dt = vars[0];
    double c = vars[1];
...
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
void inline fe_sw2_wd_densityBoundaryPressure_triangle(SVECT *elem_nds, double *elem_head, SVECT2D *grad_phi, SVECT2D *v, SVECT2D *v_wet_dry, double *f, double *f_wet_dry, double djac, double *vars, DOF_3 *rhs) {
    ...
    for (iedge=0; iedge<NDONTRI; iedge++) {
        ...
        rhs[nd1].x_eq += dely * rhst[0];
        rhs[nd2].x_eq += dely * rhst[1];
        rhs[nd1].y_eq += delx * rhst[0];
        rhs[nd2].y_eq += delx * rhst[1];
    }
}
