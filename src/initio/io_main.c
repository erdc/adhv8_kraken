 ...
 */
FILE * io_fopen_prep_ds(SMODEL *mod, const char *filename, const int ps_flag, const int grid_flag)
{
  FILE *fp = NULL;
...
/*!
   ...
   \return A pointer to the open dataset file
 */
FILE * io_fopen_prep_ds_index(SMODEL *mod, const char *filename, const int ps_flag, const int index, const int grid_flag)
{
  FILE *fp = NULL;
