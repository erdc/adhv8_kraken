...
/***********************************************************/
/***********************************************************/
void selem1d_realloc_array(SELEM_1D **elem1d, int nelems1d_old, int nelems1d_new, int nnodes) {
...
void selem1d_init_alloc_array(SELEM_1D **elem1d, int nelems1d, int nnodes) {
    selem1d_alloc_array(elem1d, nelems1d, nnodes);
